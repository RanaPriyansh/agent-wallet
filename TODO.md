...
Repository: https://github.com/RanaPriyansh/thielon-agent-wallet.git
Canonical local path: /root/git-repos/agent-wallet
Default branch: main
...
3. Run the local setup path for agent-wallet and write exact commands back into README if they are missing or stale.
